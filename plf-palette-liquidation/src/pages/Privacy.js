  ...
  return (
    <div className="legal-page">
      <div className="container">
        ...
        <p><strong>PLF - Palette Liquidation France</strong></p>
        ...
        <ul>
          ...
          <li><strong>Adresse de livraison :</strong> Adresse complète, code postal, ville</li>
          <li><strong>Informations de commande :</strong> Produits commandés, montant, date</li>
          <li><strong>Méthode de paiement choisie :</strong> Virement bancaire, Bitcoin ou Apple Pay</li>
        </ul>
        ...
        <p>
          ...
          Consultez notre <a href="/legal/cookies">Politique des Cookies</a> pour plus d'informations.
        </p>

        <h2>3. Finalités du traitement</h2>
        <p>Vos données sont utilisées pour :</p>
        <ul>
          <li><strong>Traitement des commandes :</strong> Validation, préparation, expédition</li>
          <li><strong>Communication :</strong> Confirmation de commande, suivi de livraison</li>
          <li><strong>Service client :</strong> Réponse à vos questions, réclamations</li>
          <li><strong>Gestion commerciale :</strong> Facturation, comptabilité</li>
          <li><strong>Amélioration du service :</strong> Analyse des ventes, optimisation du site</li>
          <li><strong>Newsletter :</strong> Envoi d'offres (avec votre consentement)</li>
        </ul>
        ...
        <ul>
          ...
          <li><strong>Obligation légale :</strong> Conservation des factures, comptabilité</li>
        </ul>

        <h2>5. Partage des données</h2>
        <p>Vos données peuvent être partagées avec :</p>
        <ul>
          <li><strong>Prestataires de paiement :</strong> Pour le traitement des transactions</li>
          <li><strong>Transporteurs :</strong> Pour la livraison (nom, adresse, téléphone)</li>
          <li><strong>Service d'emailing :</strong> EmailJS pour l'envoi des confirmations</li>
          <li><strong>Sous-traitants :</strong> Hébergeur, maintenance informatique</li>
        </ul>
        <p>
        ...
        <ul>
          <li><strong>Données de commande :</strong> 5 ans après la dernière commande</li>
        ...
        <ul>
          ...
          <li><strong>Droit de retrait du consentement :</strong> Pour la newsletter et cookies</li>
        </ul>
        ...
        <ul>
          ...
          <li><strong>Courrier :</strong> PLF - Service Protection des Données<br/>
              281 Rue Blanche SELVA, 66000 Perpignan, France</li>
        </ul>
        <p>
